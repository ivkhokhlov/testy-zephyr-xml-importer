...
from zephyr_xml_importer.api.serializers import validate_export_request
...
def test_validate_import_request_defaults_and_coercions():
    ...
    assert request.step_name_template is None
    assert request.step_name_overrides is None
...
def test_validate_export_request_include_step_names_coercion():
    ...
    assert request.include_step_names is True
